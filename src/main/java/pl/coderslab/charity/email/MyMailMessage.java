...
public class MyMailMessage {
    ...
    public void buildEmailForgotPass() {
        this.message = "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                "\n" +
